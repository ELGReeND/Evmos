...
install() {
	...
	wget -q "https://github.com/tharsis/evmos/releases/download/v${evmos_version}/evmos_${evmos_version}_Linux_arm64.tar.gz"
	tar -xvf "evmos_${evmos_version}_Linux_arm64.tar.gz" -C $HOME/evmos_temp
	mv $HOME/evmos_temp/bin/evmosd /usr/bin
	rm -rf $HOME/evmos_temp "evmos_${evmos_version}_Linux_arm64.tar.gz"
}
update() {
